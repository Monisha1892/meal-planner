...
export default function SearchScreen({ navigation }) {
    ...
    const handleIngredientSearch = () => {
        ...
        if (selectedIngredient && selectedIngredient.value) { // Use 'value' instead of 'id'
            navigation.navigate('IngredientDetailsScreen', { ingredientId: selectedIngredient.value });
        } else {
